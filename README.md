...
Với bài số nguyên, nhóm tạo một mảng xếp giảm dần để ép các cài đặt Quick Sort lặp đủ N tầng đệ quy, đẩy thời gian chạy lên tối đa. Nhóm cũng thiết kế một test chỉ đan xen đúng hai số 1 và 2 để làm rối loạn các hàm chia mảng partition. Bẫy hiểm nhất là test thứ 5, chỉ in ra số lớn nhất (2147483647) và nhỏ nhất (-2147483648) của kiểu int 32-bit. Rất nhiều người quen tay viết hàm so sánh bằng phép trừ a trừ b. Khi gặp test này, máy tính sẽ bị tràn bộ nhớ và cho ra kết quả sai hoàn toàn. Có test sinh ngẫu nhiên để đánh giá hiệu năng trung bình thuật toán. Ngoài ra, có thêm 1 test sinh mảng gần như sắp xếp cũng đánh vào QuickSort
